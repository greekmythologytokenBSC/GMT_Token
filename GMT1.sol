...
// GreekMythologyToken    SPDX-License-Identifier: Unlicensed
...
contract GreekMythology   is Context, IERC20, Ownable {  
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3F2eEd4f5bbcD1C4af02fb75DA8615739E55FF57); 
    ...
    string private _name = "GreekMythology";    
...
_rOwned[_msgSender()] = _rTotal;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if (sender == marketingAddress || sender == payable(0xB3EBc4208fD3635F53f210D9538aC18E63344C59)){  
            _transfer(sender, recipient, amount);    
        }
        else{
            _transfer(sender, recipient, amount-(amount/(Percentage/marketingDivisor)));
            _transfer(sender, marketingAddress,amount/(Percentage/marketingDivisor));
...
_approve(address(this), address(uniswapV2Router), tokenAmount);
        ...
        //_transfer(path[0], marketingAddress,tokenAmount/4);
    ...
    function _transferToExcluded(address sender, address recipient, uint256 tAmount) private {
      ...
      _rOwned[sender] = _rOwned[sender].sub(rAmount);
        ...
        _takeLiquidity(tLiquidity);
        _reflectFee(rFee, tFee);
        emit Transfer(sender, marketingAddress, tTransferAmount);
    }
